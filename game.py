...
class SnakeGame:
	...
	def play_step(self,action_vector):
		...
		Params:
			action_vector : array
				binary array determing movement of snake in current step - [straight,right,left] 
		'''
		pygame.event.pump() # prevents display from freezing
		...
		# check if head is at food or if game is over
